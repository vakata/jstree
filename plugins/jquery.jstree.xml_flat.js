			...
			return {
				get		: function(obj, t, opts) {
					...
					if(obj.size() > 1) {
						...
						var str	 = '<root>';
						obj.each(function () {
							str += _this.get(this, t, $.extend(true, {}, opts, { callback : true }));
						});
						str		+= '</root>';
						return str;
					}
				...
				process_inner : function(obj, t, opts, lang) {
					...
					if(opts.inner_attrib.length || obj.children("ins").get(0).style.backgroundImage.toString().length || obj.children("ins").get(0).className.length) {
						if(obj.children("ins").get(0).style.className && obj.children("ins").get(0).style.className.length) {
							str += ' icon="' + obj.children("ins").get(0).style.className + '" ';
						}
						if(obj.children("ins").get(0).style.backgroundImage && obj.children("ins").get(0).style.backgroundImage.length) {
